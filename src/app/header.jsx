...
export const HeaderComponent = () => {
  ...
  return (
    <div className="hidden lg:block fixed w-full bg-lime-500 shadow-md border-b border-gray-300 z-10">
      ...
      >
        <div className="mt-16 flex flex-col justify-start items-center relative gap-8 px-1">
          ...
          <button
            ...
            className="bg-indigo-500 hover:bg-blue-700 rounded-full px-2 py-2 text-white font-semibold flex justify-center items-center gap-1 border border-black"
          >
            <AddRoundedIcon fontSize="small" className="text-white" />
            PRIVATE DISCUSSION POST
          </button>
